...
describe('User endpoints', function() {
    ...
    describe('/users', function() {
        describe('GET', function() {
            it('should return a list of users', function() {
              ///////////
                var user = {
                    username: 'joe',
                    password: '$2a$06$cvPc5AnE5KDOWEyNxb0QmOR2gLDWswDuA9DHYbz9DgzsAdTgQKalm'
                };
        ...
        describe('POST', function() {
            ...
            it('should reject users with an empty password', function() {
              var user = {
                  username: 'joe',
                  password: ''
              };
